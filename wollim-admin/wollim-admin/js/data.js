  ...
  english: [
    {
      ...
      subEvents: [
        { id:"ev1-01", title:"01. New York",       emoji:"🗽", tracks:[{ id:"evt-01-t1",title:"01. New York 음원" }],        videos:[{ id:"evt-01-v1",title:"01. New York 영상" }],        plans:[{ id:"evt-01-p1",title:"01. New York 계획안" }] },
        { id:"ev1-02", title:"02. Texas",           emoji:"🤠", tracks:[{ id:"evt-02-t1",title:"02. Texas 음원" }],           videos:[{ id:"evt-02-v1",title:"02. Texas 영상" }],           plans:[{ id:"evt-02-p1",title:"02. Texas 계획안" }] },
        { id:"ev1-03", title:"03. Harvard",         emoji:"🎓", tracks:[{ id:"evt-03-t1",title:"03. Harvard 음원" }],         videos:[{ id:"evt-03-v1",title:"03. Harvard 영상" }],         plans:[{ id:"evt-03-p1",title:"03. Harvard 계획안" }] },
        { id:"ev1-04", title:"04. Florida",         emoji:"🐊", tracks:[{ id:"evt-04-t1",title:"04. Florida 음원" }],         videos:[{ id:"evt-04-v1",title:"04. Florida 영상" }],         plans:[{ id:"evt-04-p1",title:"04. Florida 계획안" }] },
        { id:"ev1-05", title:"05. San Francisco",   emoji:"🌉", tracks:[{ id:"evt-05-t1",title:"05. San Francisco 음원" }],   videos:[{ id:"evt-05-v1",title:"05. San Francisco 영상" }],   plans:[{ id:"evt-05-p1",title:"05. San Francisco 계획안" }] },
        { id:"ev1-06", title:"06. Iowa",            emoji:"🌽", tracks:[{ id:"evt-06-t1",title:"06. Iowa 음원" }],            videos:[{ id:"evt-06-v1",title:"06. Iowa 영상" }],            plans:[{ id:"evt-06-p1",title:"06. Iowa 계획안" }] },
        { id:"ev1-07", title:"07. New Orleans",     emoji:"🎺", tracks:[{ id:"evt-07-t1",title:"07. New Orleans 음원" }],     videos:[{ id:"evt-07-v1",title:"07. New Orleans 영상" }],     plans:[{ id:"evt-07-p1",title:"07. New Orleans 계획안" }] },
        { id:"ev1-09", title:"09. Vermont",         emoji:"🍁", tracks:[{ id:"evt-09-t1",title:"09. Vermont 음원" }],         videos:[{ id:"evt-09-v1",title:"09. Vermont 영상" }],         plans:[{ id:"evt-09-p1",title:"09. Vermont 계획안" }] },
        { id:"ev1-10", title:"10. Alaska",          emoji:"🏔", tracks:[{ id:"evt-10-t1",title:"10. Alaska 음원" }],          videos:[{ id:"evt-10-v1",title:"10. Alaska 영상" }],          plans:[{ id:"evt-10-p1",title:"10. Alaska 계획안" }] },
        { id:"ev1-11a",title:"11. Minnesota",       emoji:"❄️", tracks:[{ id:"evt-11a-t1",title:"11. Minnesota 음원" }],      videos:[{ id:"evt-11a-v1",title:"11. Minnesota 영상" }],      plans:[{ id:"evt-11a-p1",title:"11. Minnesota 계획안" }] },
        { id:"ev1-11b",title:"11. Washington D.C",  emoji:"🏛", tracks:[{ id:"evt-11b-t1",title:"11. Washington D.C 음원" }], videos:[{ id:"evt-11b-v1",title:"11. Washington D.C 영상" }], plans:[{ id:"evt-11b-p1",title:"11. Washington D.C 계획안" }] },
        { id:"ev1-12", title:"12. Hollywood",       emoji:"🎬", tracks:[{ id:"evt-12-t1",title:"12. Hollywood 음원" }],       videos:[{ id:"evt-12-v1",title:"12. Hollywood 영상" }],       plans:[{ id:"evt-12-p1",title:"12. Hollywood 계획안" }] },
      ],
    },
    {
